...
import logo from '/home/ukijaffna/Documents/october14/swapSmartFrontend/src/assets/lo2.jpg';  // Import the logo image
import lockIcon from '/home/ukijaffna/Documents/october14/swapSmartFrontend/src/assets/lo2.jpg'; // Add your lock icon image path here
        ...
        <div className="user-info-section">
          ...
          {data.image && (
            <div className="image-section">
              <h3>Course Image</h3>
              <img
                src={`http://localhost:8703/imageUploads/${data.image}`}
                alt="Course uploaded"
